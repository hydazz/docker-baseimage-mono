...
echo "## docker-baseimage-alpine-mono
...
![alpine](https://img.shields.io/badge/alpine-edge-0D597F?style=for-the-badge&logo=alpine-linux) ![mono](https://img.shields.io/badge/mono-${MONO}-blue?style=for-the-badge)
...
[monourl]: https://www.mono-project.com" >README.md
